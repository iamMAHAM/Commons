...
import net.alcall.commons.compose.screens.*
import net.alcall.commons.compose.theme.AppThemeSurface
import net.alcall.commons.dialogs.ConfirmationAdvancedAlertDialog
...
class AboutActivity : BaseComposeActivity() {
    ...
    private fun launchEmailIntent() {
        ...
        val address = if (packageName.startsWith("net.alcall")) {
