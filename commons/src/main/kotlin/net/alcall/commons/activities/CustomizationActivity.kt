...
import net.alcall.commons.databinding.ActivityCustomizationBinding
import net.alcall.commons.dialogs.*
import net.alcall.commons.extensions.*
import net.alcall.commons.helpers.*
import net.alcall.commons.helpers.MyContentProvider.COL_ACCENT_COLOR
import net.alcall.commons.helpers.MyContentProvider.COL_APP_ICON_COLOR
import net.alcall.commons.helpers.MyContentProvider.COL_BACKGROUND_COLOR
import net.alcall.commons.helpers.MyContentProvider.COL_PRIMARY_COLOR
import net.alcall.commons.helpers.MyContentProvider.COL_TEXT_COLOR
import net.alcall.commons.helpers.MyContentProvider.COL_THEME_TYPE
import net.alcall.commons.helpers.MyContentProvider.GLOBAL_THEME_CUSTOM
import net.alcall.commons.helpers.MyContentProvider.GLOBAL_THEME_DISABLED
import net.alcall.commons.helpers.MyContentProvider.GLOBAL_THEME_SYSTEM
import net.alcall.commons.models.GlobalConfig
import net.alcall.commons.models.MyTheme
import net.alcall.commons.models.RadioItem
import net.alcall.commons.models.isGlobalThemingEnabled
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("net.alcall.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
