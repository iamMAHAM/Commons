...
import net.alcall.commons.compose.extensions.onEventValue
import net.alcall.commons.compose.screens.ManageBlockedNumbersScreen
import net.alcall.commons.compose.theme.AppThemeSurface
import net.alcall.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import net.alcall.commons.dialogs.ExportBlockedNumbersDialog
import net.alcall.commons.dialogs.FilePickerDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("net.alcall.phone")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("net.alcall.phone")) {
