...
import net.alcall.commons.adapters.setupSimpleListItem
import net.alcall.commons.compose.alert_dialog.dialogContainerColor
import net.alcall.commons.compose.alert_dialog.dialogTextColor
import net.alcall.commons.compose.bottom_sheet.BottomSheetColumnDialogSurface
import net.alcall.commons.compose.bottom_sheet.BottomSheetDialogState
import net.alcall.commons.compose.bottom_sheet.BottomSheetSpacerEdgeToEdge
import net.alcall.commons.compose.bottom_sheet.rememberBottomSheetDialogState
...
import net.alcall.commons.databinding.ItemSimpleListBinding
import net.alcall.commons.fragments.BaseBottomSheetDialogFragment
import net.alcall.commons.models.SimpleListItem

open class BottomSheetChooserDialog : net.alcall.commons.fragments.BaseBottomSheetDialogFragment() {
