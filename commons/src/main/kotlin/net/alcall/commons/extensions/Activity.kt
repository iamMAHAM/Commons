...
import net.alcall.commons.databinding.DialogTitleBinding
...
import net.alcall.commons.helpers.MyContentProvider.COL_LAST_UPDATED_TS
import net.alcall.commons.helpers.MyContentProvider.MY_CONTENT_URI
import net.alcall.commons.models.*
import net.alcall.commons.views.MyTextView
import java.io.*
...
fun Activity.launchPurchaseThankYouIntent() {
    hideKeyboard()
    try {
        launchViewIntent("market://details?id=net.alcall.thankyou")
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "net.alcall.gallery" || applicationId == "net.alcall.gallery.debug") {
...
fun BaseSimpleActivity.launchCallIntent(recipient: String, handle: PhoneAccountHandle? = null) {
    handlePermission(PERMISSION_CALL_PHONE) {
        ...
        Intent(action).apply {
            ...
            if (isDefaultDialer()) {
                val packageName = if (baseConfig.appId.contains(".debug", true)) "net.alcall.phone.debug" else "net.alcall.phone"
                val className = "net.alcall.phone.activities.DialerActivity"
