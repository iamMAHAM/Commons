...
import net.alcall.commons.helpers.MyContentProvider.PERMISSION_WRITE_GLOBAL_SETTINGS
import net.alcall.commons.models.AlarmSound
import net.alcall.commons.models.BlockedNumber
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://net.alcall.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("net.alcall.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("net.alcall.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("net.alcall."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("net.alcall.contacts") && !packageName.startsWith("net.alcall.phone")) {
        true
    } else if ((packageName.startsWith("net.alcall.contacts") || packageName.startsWith("net.alcall.phone")) && isQPlus()) {
