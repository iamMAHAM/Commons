package net.alcall.commons.fragments
...
import net.alcall.commons.databinding.DialogBottomSheetBinding
...
abstract class BaseBottomSheetDialogFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val title = arguments?.getInt(net.alcall.commons.fragments.BaseBottomSheetDialogFragment.Companion.BOTTOM_SHEET_TITLE).takeIf { it != 0 }
