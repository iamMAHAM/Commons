...
import net.alcall.commons.extensions.getIntValue
import net.alcall.commons.extensions.getStringValue
import net.alcall.commons.models.PhoneNumber
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "net.alcall.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "net.alcall.phone" && packageName != "net.alcall.messages" && packageName != "net.alcall.calendar") {
                return contacts
            }
