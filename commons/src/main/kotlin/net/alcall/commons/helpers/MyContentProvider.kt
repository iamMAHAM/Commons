...
object MyContentProvider {
    private const val AUTHORITY = "net.alcall.android.provider"
    val MY_CONTENT_URI: Uri = Uri.parse("content://$AUTHORITY/settings")

    const val ACTION_GLOBAL_CONFIG_UPDATED = "net.alcall.android.GLOBAL_CONFIG_UPDATED"
    const val PERMISSION_WRITE_GLOBAL_SETTINGS = "net.alcall.android.permission.WRITE_GLOBAL_SETTINGS"
